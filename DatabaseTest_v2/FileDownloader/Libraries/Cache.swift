...
public class Cache<T: NSCoding> {
    ...
    private func pathForKey(key: String) -> String {
      ...
      // print(((cacheDirectory as NSString).stringByAppendingPathComponent(k) as NSString).stringByAppendingPathExtension("cache")!)
        return ((cacheDirectory as NSString).stringByAppendingPathComponent(k) as NSString).stringByAppendingPathExtension("cache")!
    }
